...
class Category(Base):
    ...
    # this is the self refrencing foreign key
    # parent_id = Column(ForeignKey("category.id"), nullable=True)
    #or
    # category_id = Column(ForeignKey("category.id"), nullable=False)
    # i have Category id 1 and don't have the category_id _ and we had a name of product
    # 1 _ Electronics
    # now the second record will refer to the first record
    # 2 1 Television
    # 3 1 Mobile Phones
    # 4 2 LED TV
    # 5 2 Smart TV
